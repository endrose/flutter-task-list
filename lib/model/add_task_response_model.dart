...
class AddTasksResponseModel {
  ...
  factory AddTasksResponseModel.fromJson(String str) =>
      AddTasksResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AddTasksResponseModel.fromMap(Map<String, dynamic> json) =>
      AddTasksResponseModel(
